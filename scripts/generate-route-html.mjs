...
function applyMetadata(html, metadata) {
  ...
  return html
    ...
    .replace(
      ...
      metaProperty('og:image', defaultImageUrl),
    )
    .replace(
      /<meta property="og:image:alt" content="[^"]*">/,
      metaProperty('og:image:alt', defaultImageAlt),
    )
    .replace(
    ...
    .replace(
      ...
      metaName('twitter:image', defaultImageUrl),
    )
    .replace(
      /<meta name="twitter:image:alt" content="[^"]*">/,
      metaName('twitter:image:alt', defaultImageAlt),
    );
}
