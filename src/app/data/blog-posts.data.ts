...
export const blogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      'Sometime during all of that, I dropped the penne into boiling, salted water. Once the sauce had simmered for about 15 minutes, it was time to toss in the spinach. I cranked the heat up to medium for 30 to 60 seconds and added a splash of pasta water to help the sauce come together and thin out a bit. Finally, I added the penne, stirred until it was coated, and killed the heat.',
    ...
    recipeNotes: [
      ...
      'Cook the chicken to 165°F, rest it for about five minutes, then slice it over the pasta and finish with feta and parsley.',
    ],
    recipeDownload: {
